    ...
    <>
      ...
      >
        {points.map((p, i) => (
          ...
          >
            ...
            <div style={{ fontSize: "19px", fontWeight: 700, letterSpacing: "-0.02em", lineHeight: 1.2, marginBottom: "2px", color: "white" }}>
              {p.headline}
            </div>
            <div style={{ fontSize: "19px", fontWeight: 700, letterSpacing: "-0.02em", lineHeight: 1.2, marginBottom: "14px", color: p.color, whiteSpace: "nowrap" }}>
              {p.sub}
            </div>
            <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.45)", lineHeight: 1.7, flex: 1 }}>
              {p.description}
            </p>
          </motion.div>
        ))}
      ...
      <style>{`
        @media (max-width: 1024px) {
          .painpoints-grid { grid-template-columns: repeat(3, 1fr) !important; }
        }
